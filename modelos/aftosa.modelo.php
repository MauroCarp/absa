...
class ModeloAftosa{
    ...
    static public function mdlCargarData($tabla,$valor){
		...
		if($tabla == 'animales'){
			...
			porcinos = :porcinos,
			equinos = :equinos,
			intercampania = :intercampania
			WHERE renspa = '" . $valor['renspa'] . "' AND campania = " . $valor['campania']);
	
			$stmt->bindParam(":vacas", $valor['vacas'], PDO::PARAM_STR);
			$stmt->bindParam(":vaquillonas", $valor['vaquillonas'], PDO::PARAM_STR);
			$stmt->bindParam(":toros", $valor['toros'], PDO::PARAM_STR);
			$stmt->bindParam(":toritos", $valor['toritos'], PDO::PARAM_STR);
			$stmt->bindParam(":terneros", $valor['terneros'], PDO::PARAM_STR);
			$stmt->bindParam(":terneras", $valor['terneras'], PDO::PARAM_STR);
			$stmt->bindParam(":novillos", $valor['novillos'], PDO::PARAM_STR);
			$stmt->bindParam(":novillitos", $valor['novillitos'], PDO::PARAM_STR);
			$stmt->bindParam(":caprinos", $valor['caprinos'], PDO::PARAM_STR);
			$stmt->bindParam(":ovinos", $valor['ovinos'], PDO::PARAM_STR);
			$stmt->bindParam(":porcinos", $valor['porcinos'], PDO::PARAM_STR);
			$stmt->bindParam(":equinos", $valor['equinos'], PDO::PARAM_STR);
			$stmt->bindParam(":intercampania", $valor['intercampania'], PDO::PARAM_STR);
		}

		if($tabla == 'actas'){
			$stmt = Conexion::conectar()->prepare("INSERT INTO $tabla(renspa,campania,matricula,fechaVacunacion,acta,cantidadPar,fechaRecepcion,vacunoCar,cantidadCar,intercampania)
			VALUES (:renspa,:campania,:matricula,:fechaVacunacion,:acta,:cantidadPar,:fechaRecepcion,:vacunoCar,:cantidadCar,:intercampania)");
			print_r($valor);
			$stmt->bindParam(":renspa", $valor['renspa'], PDO::PARAM_STR);
			$stmt->bindParam(":campania", $valor['campania'], PDO::PARAM_STR);
			$stmt->bindParam(":matricula", $valor['matricula'], PDO::PARAM_STR);
			$stmt->bindParam(":fechaVacunacion", $valor['fechaVacunacion'], PDO::PARAM_STR);
			$stmt->bindParam(":acta", $valor['acta'], PDO::PARAM_STR);
			$stmt->bindParam(":cantidadPar", $valor['cantidadPar'], PDO::PARAM_STR);
			$stmt->bindParam(":fechaRecepcion", $valor['fechaRecepcion'], PDO::PARAM_STR);
			$stmt->bindParam(":vacunoCar", $valor['vacunoCar'], PDO::PARAM_STR);
			$stmt->bindParam(":cantidadCar", $valor['cantidadCar'], PDO::PARAM_STR);
			$stmt->bindParam(":intercampania", $valor['intercampania'], PDO::PARAM_STR);
		}
